app that has 5 default tables

check if there is an empty table

if there is an empty table allow to make reservation

if not add to waitlist

/ show html home page
/tables show page and get information from api
/reserve show page and post information 
